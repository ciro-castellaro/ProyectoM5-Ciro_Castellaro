...
30 tests con Vitest, deterministas, **sin ninguna llamada real a la API de GitHub** (el cliente de Octokit se mockea inyectándolo en el constructor de `GitHubClient`):
...
- `tests/errors.test.ts` — clasificación y traducción de errores (401/403/404/422/5xx) a mensajes en lenguaje natural.
